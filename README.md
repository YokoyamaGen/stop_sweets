...
モデルスペック、リクエストスペックを実装することで、アプリの品質を向上するように致しました。テストを実施する際に正常系と異常系を意識したことや自身でサービスを利用してみることでバグを発見して、改善することで品質を向上致しました。例えば、ユーザ情報の名前やメールアドレス、つぶやき機能における投稿において、規定した文字数以上の場合やブランクを禁止していた箇所にブランクで入力した場合、想定通りにエラーメッセージが出力されるようになっているかを確認致しました。
